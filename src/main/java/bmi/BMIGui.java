...
public class BMIGui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Underwieght = < 18.5");

        jLabel9.setText("Healthy Weight = 18.5 - 24.9");

        jLabel10.setText("Overwieght = 25.0 - 29.9");

        jLabel11.setText("Obesity = > 29.9");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sPounds = jTextField3.getText();
        double iPounds = Double.parseDouble(sPounds);
        
        BMICalculator b = new BMICalculator();
        double bmi = b.calculator(iFeet, iInches, iPounds);
        
        jTextField4.setText(bmi+"");
